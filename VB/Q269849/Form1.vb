...
Namespace Q269849
    Partial Public Class Form1
        ...
        Private Sub CreatePathNeedle(ByVal needle As INeedle)
            ...
            shape.Points = New ShapePoint() { _
                New ShapePoint(New PointF(0, 20), PathPointType.Start), _
                New ShapePoint(New PointF(50, 0), PathPointType.Line), _
                New ShapePoint(New PointF(0, -20), PathPointType.Line), _
                New ShapePoint(New PointF(100, 0), PathPointType.Line), _
                New ShapePoint(New PointF(0, 20), PathPointType.CloseSubpath Or PathPointType.Line) _
            }

            Dim brush As New SolidBrushObject(Color.Red)
        ...
        Private Sub CreateComplexNeedle(ByVal needle As INeedle)
            ...
            Dim basic As New PolylineShape(New PointF() { _
                New PointF(25, 20), _
                New PointF(100, 0), _
                New PointF(25, -20), _
                New PointF(95, 0), _
            ...
            Dim cap As New PolylineShape(New PointF() { _
                New PointF(100, 0), _
                New PointF(105, 5), _
                New PointF(110, 0), _
                New PointF(105, -5) _
